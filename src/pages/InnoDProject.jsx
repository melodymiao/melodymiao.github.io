...
import InnoDPreview from '../assets/images/innod/innod preview.png'
  ...
  return (
    ...
    <section id="innod-project-landing-section" className="project-landing-section">
        <div className='header-img-wrapper'>
            <img id='innod-logo' className='logo' src={InnoD} />
            <img id='innod-preview' className='preview' src={InnoDPreview} />
        </div>
    </section>
