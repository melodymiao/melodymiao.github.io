  ...
  return (
    ...
    <body>
      ...
      <section className='section'>
        <section className='two-column-text'>
          <div className='left-column'>
            ...
            <ol>
              <li class="project-text">At-a-glance habit tracking through clear visuals</li>
              <li class="project-text">Habit sharing with friends for accountability</li>
              <li class="project-text">Photo sharing for progress visualization</li>
            </ol>
          </div>
          <div className='right-column'>
      ...
      <section className='solution-section'>
        ...
        <div className='two-columns'>
          <div className='img-caption'>
            <img id='recommended-text' src={RecommendedText} />
          </div>
          <div className='img-caption'>
            <img id='completed-today' src={CompletedToday} />
          </div>
        </div>
      </section>
