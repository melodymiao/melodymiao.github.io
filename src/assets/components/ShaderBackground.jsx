...
const ShaderBackground = ({ mood = 'clear', tempF = 70, city, condition, gradientOn = true }) => {
  ...
  return (
    <div
      style={{
        ...
        // and just sits behind the canvas once it's ready. The plain theme
        // skips this entirely — its own flat #f9f9f9 page background (see
        // Home.css) already shows through this transparent div.
        ...(gradientOn && {
    ...
    >
      ...
      <WeatherOverlay condition={condition} isNight={isNight} mono={!gradientOn} />
    </div>
  );
};
